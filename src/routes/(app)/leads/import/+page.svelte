...
<main class="flex-1 items-start space-y-4 p-4">
	<div class="mx-2 grid w-full max-w-6xl gap-2">
		<h1 class="text-3xl font-semibold">Import Leads</h1>
		<p class="text-muted-foreground">
			Upload a CSV file to bulk import leads. The CSV file should have the headers with the exact
			column names.
		</p>
	</div>
	<Card.Root>
		<Card.Header>
			<InputChip name="lists" placeholder="Enter lists to subscribe to" />
		</Card.Header>
		<Card.Content>
